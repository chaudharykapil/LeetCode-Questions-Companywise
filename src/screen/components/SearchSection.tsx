...
export default function SearchSection({}: Props) {
  return (
    <div className='h-screen flex flex-col items-center gap-y-14'>
        <div className='text-4xl font-semibold text-left mt-32 leading-relaxed min-h-32'>
            <Typewriter
            onInit={(typewriter) => {
                typewriter.typeString('From Practice to Perfection<br>Your DSA Journey Starts Here')
                .pauseFor(2500)
                .deleteAll()
                .start();
            }}
